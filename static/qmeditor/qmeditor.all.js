 ...
 * UEditor
 * version: qmeditor
 * build: Fri Nov 15 2019 10:42:24 GMT+0800 (GMT+08:00)
 */

;(function() {
  // ueditor-1.4.3.3/_src/editor.js
  ...
  // ueditor-1.4.3.3/_src/core/browser.js
  /**
   * 浏览器判断模块
   * @file
   * @module UE.browser
  ...
  // ueditor-1.4.3.3/_src/core/utils.js
  /**
   * 工具函数包
   * @file
   * @module UE.utils
  ...
  // ueditor-1.4.3.3/_src/core/EventBase.js
  /**
   * UE采用的事件基类
   * @file
   * @module UE
  ...
  // ueditor-1.4.3.3/_src/core/dtd.js
  ///import editor.js
  ...
  // ueditor-1.4.3.3/_src/core/domUtils.js
  /**
   * Dom操作工具包
   * @file
  ...
  var fillCharReg = new RegExp(domUtils.fillChar, 'g')
    ...
    // ueditor-1.4.3.3/_src/core/Range.js
    /**
     * Range封装
     * @file
     * @module UE.dom
  ...
  // ueditor-1.4.3.3/_src/core/Selection.js
  /**
   * 选集
   * @file
   * @module UE.dom
  ...
  // ueditor-1.4.3.3/_src/core/Editor.js
  /**
  ...
  // ueditor-1.4.3.3/_src/core/Editor.defaultoptions.js
  //维护编辑器一下默认的不在插件中的配置项
  ...
  // ueditor-1.4.3.3/_src/core/filterword.js
  /**
   * UE过滤word的静态方法
   * @file
   */
  ...
  var filterWord = (UE.filterWord = (function() {
    ...
    // ueditor-1.4.3.3/_src/core/node.js
    /**
     * 编辑器模拟的节点类
     * @file
     * @module UE
  ...
  // ueditor-1.4.3.3/_src/core/htmlparser.js
  /**
   * html字符串转换成uNode节点
   * @file
   * @module UE
  ...
  // ueditor-1.4.3.3/_src/core/filternode.js
  /**
   * UE过滤节点的静态方法
   * @file
   */
  ...
  // ueditor-1.4.3.3/_src/core/plugin.js
  /**
  ...
  // ueditor-1.4.3.3/_src/core/keymap.js
  ...
  // ueditor-1.4.3.3/_src/core/localstorage.js
  //存储媒介封装
  ...
  // ueditor-1.4.3.3/_src/plugins/inserthtml.js
  /**
   * 插入html字符串插件
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/image.js
  /**
   * 图片插入、排版插件
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/justify.js
  /**
   * 段落格式
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/font.js
  /**
  ...
  // ueditor-1.4.3.3/_src/plugins/link.js
  /**
   * 超链接
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/removeformat.js
  /**
   * 清除格式
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/indent.js
  /**
   * 首行缩进
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/paragraph.js
  /**
   * 段落样式
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/directionality.js
  /**
   * 设置文字输入的方向的插件
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/horizontal.js
  /**
   * 插入分割线插件
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/rowspacing.js
  /**
   * 段前段后间距插件
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/lineheight.js
  /**
   * 设置行内间距
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/anchor.js
  /**
  ...
  // ueditor-1.4.3.3/_src/plugins/wordcount.js
  ///import core
  ///commands 字数统计
 ...
 */
  ...
  // ueditor-1.4.3.3/_src/plugins/dragdrop.js
  ...
  // ueditor-1.4.3.3/_src/plugins/undo.js
  /**
   * undo redo
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/copy.js
  ...
  // ueditor-1.4.3.3/_src/plugins/paste.js
  ///import core
  ...
  // ueditor-1.4.3.3/_src/plugins/puretxtpaste.js
  /**
   * 纯文本粘贴插件
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/list.js
  /**
   * 有序列表,无序列表插件
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/source.js
  /**
   * 源码编辑插件
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/enterkey.js
  ///import core
  ///import plugins/undo.js
  ///commands 设置回车标签p或br
  ...
  // ueditor-1.4.3.3/_src/plugins/keystrokes.js
  /* 处理特殊键的兼容性问题 */
  ...
  // ueditor-1.4.3.3/_src/plugins/table.core.js
  /**
  ...
  // ueditor-1.4.3.3/_src/plugins/table.cmds.js
  /**
   * Created with JetBrains PhpStorm.
   * User: taoqili
   * Date: 13-2-20
  ...
  // ueditor-1.4.3.3/_src/plugins/table.action.js
  /**
   * Created with JetBrains PhpStorm.
   * User: taoqili
   * Date: 12-10-12
  ...
  // ueditor-1.4.3.3/_src/plugins/table.sort.js
  /**
   * Created with JetBrains PhpStorm.
   * User: Jinqn
   * Date: 13-10-12
  ...
  // ueditor-1.4.3.3/_src/plugins/shortcutmenu.js
  ///import core
  ///commands       弹出菜单
  ...
  // ueditor-1.4.3.3/_src/plugins/basestyle.js
  /**
   * B、I、sub、super命令支持
   * @file
   * @since 1.2.6.1
  ...
  // ueditor-1.4.3.3/_src/plugins/searchreplace.js
  ///import core
  ///commands 查找替换
  ...
  // ueditor-1.4.3.3/_src/plugins/xssFilter.js
  /**
   * @file xssFilter.js
   * @desc xss过滤器
   * @author robbenmu
  ...
  // ueditor-1.4.3.3/_src/ui/ui.js
  var baidu = baidu || {}
  baidu.editor = baidu.editor || {}
  UE.ui = baidu.editor.ui = {}

  // qmEditor/js/qmEditor.js
  var regQmEditorButton = function(btnCmd) {
    var ci = btnCmd.name.toLowerCase()
    UE.commands[ci] = {
      execCommand: btnCmd.execCommand,
      queryCommandState: btnCmd.queryCommandState
    }
    var editorui = baidu.editor.ui
    editorui[ci] = (function(cmd) {
      return function(editor) {
        var ui = new editorui.Button({
          className: 'edui-for-' + btnCmd.name,
  ...
  var regQmEditorMenu = function(menuCmd) {
      if (regQmEditorMenu.addOnMenu) {
      } else {
        regQmEditorMenu.addOnMenu = []
      }
      var cmdName = menuCmd.cmdName.toLowerCase()
      UE.commands[cmdName] = {
        execCommand: menuCmd.execCommand,
        queryCommandState: menuCmd.queryCommandState
      }
      regQmEditorMenu.addOnMenu.push({
        label: menuCmd.label,
        cmdName: cmdName,
        value: 'qmEditorAddonMenu'
      })
    }

    // qmEditorSkipserverconfig/js/skipServerConfig.js
  ;(function() {
  ...
  //         name: 'qmEditorImageDialog',
  //         iframeUrl: './qmEditorAddon/qmEditorImage/qmEditorImage.html',
  //         editor: me,
  //         title: '插入图片',
  ...
  ;(function() {
    regQmEditorButton({
      ...
      execCommand: function(cmd, param) {
        ...
        // var dialog = new baidu.editor.ui.Dialog({
        //   name: 'qmEditorImageDialog',
        //   iframeUrl: '/#/materialPicture',
        //   editor: me,
        //   title: '插入素材库图片',
        //   cssRules: 'position:relative;width:1000px;height:330px;'
        // })
        // dialog.render()
        // dialog.open()
      },
  ...
  // qmEditorForm/js/qmEditorForm.js
  // ;(function() {
  //   regQmEditorButton({
  //     name: 'qmEditorForm',
  //     execCommand: function(cmd, param) {
  //       var me = this
  //       var dialog = new baidu.editor.ui.Dialog({
  //         name: 'qmEditorFormDialog',
  //         iframeUrl: './qmEditorAddon/qmEditorForm/qmeditor-form.html',
  //         editor: me,
  //         title: '插入表单项目',
  //         cssRules: 'width:600px;height:300px;'
  //       })
  ...
  //   regQmEditorMenu({
  //     label: '设置Label项目值',
  //     cmdName: 'qmEditorSetLabelValue',
  //     execCommand: function(cmd) {
  //       var me = this
  //       var dialog = new baidu.editor.ui.Dialog({
  //         name: 'qmEditorSetLabelValue',
  //         iframeUrl: './qmEditorAddon/qmEditorForm/qmeditor-setlblval.html',
  //         editor: me,
  //         title: '设置Label项目值',
  //         cssRules: 'width:600px;height:300px;'
  //       })
  ...
  //       if (arg === 'qmEditorAddonMenu') {
  //         return 0
  //       }
  //       var srcElement = null
  //       if (window.qmEditorData) {
  //         if (window.qmEditorData.contextmenu) {
  //           srcElement = window.qmEditorData.contextmenu.srcElement
  //         }
  //       }
  //       if (srcElement) {
  //         if (srcElement.tagName === 'SPAN') {
  //           if (srcElement.hasAttribute('qmcode')) {
  //             if (window.qmEditorData) {
  //             } else {
  //               window.qmEditorData = {}
  //             }
  //             if (window.qmEditorData.form) {
  //             } else {
  //               window.qmEditorData.form = {}
  //             }
  //             window.qmEditorData.form.currSpan = srcElement
  //             return 0
  //           }
  //         }
  //       }
  ...
  // qmEditorFullscreen/js/qmEditorFullscreen.js
  ;(function() {
    regQmEditorButton({
      name: 'qmEditorFullscreen',
      execCommand: function(cmd, param) {
        var me = this
        var frm = window.frameElement
        if (frm.hasAttribute('qmEditorFullscreen')) {
          var frmN = frm
          var frmO = window.frmO
          frmO.contentWindow.setContent(frmN.contentWindow.getContent())
          frmN.remove()
          frmO.contentWindow.editorFocus()
        } else {
          var frmO = frm
          var frmN = document.createElement('iframe')
          frmN.src = frmO.src
          frmN.style = 'position:fixed;top:0px;left:0px;width:100%;height:100%;z-index:9999;'
          frmN.setAttribute('qmEditorFullscreen', '1')
          window.top.document.body.appendChild(frmN)
          frmN.addEventListener('qmEditorInit', function(event) {
            frmN.contentWindow.frmO = frmO
            frmN.contentWindow.setContent(frmO.contentWindow.getContent())
            frmN.contentWindow.editorFocus()
          })
        }
      },
      queryCommandState: function() {
        var frm = window.frameElement
        return frm.hasAttribute('qmEditorFullscreen') ? 1 : 0
      }
    })
  })()

  // qmEditorPreview/js/qmEditorPreview.js
  ;(function() {
    regQmEditorButton({
      name: 'qmEditorPreview',
      execCommand: function(cmd) {
        var me = this
        var subWin = window.open('', 'qmEditor_win_preview', 'channelmode=yes,directories=no,fullscreen=yes,location=no,menubar=no,status=no,titlebar=no,toolbar=no', true)
        subWin.focus()
        ...
        subDoc.writeln('<link rel="stylesheet" type="text/css" href="./qmEditorAddon/qmEditor/qmEditor.css" />')
        subDoc.writeln('<link rel="stylesheet" type="text/css" href="./qmEditorAddon/qmEditorPreview/preview.css" />')
        subDoc.writeln('<script type="text/javascript" charset="utf-8" src="./qmEditorAddon/qmEditorPreview/preview.js"></script>')
        subDoc.writeln('</head>')
        subDoc.writeln('<body>')
        subDoc.writeln('<header></header>')
        subDoc.writeln('<content>')
        subDoc.writeln(me.getContent())
        subDoc.writeln('</content>')
        subDoc.writeln('</body>')
        subDoc.writeln('</html>')
        subDoc.close()
  ...
  // qmEditorTrLoop/js/qmEditorTrLoop.js
  ;(function() {
    regQmEditorMenu({
      label: '设置行循环',
      cmdName: 'qmEditorTrLoop',
      execCommand: function(cmd) {
        var me = this
        var dialog = new baidu.editor.ui.Dialog({
          name: 'qmEditorTrLoopDialog',
          iframeUrl: './qmEditorAddon/qmEditorTrLoop/qmeditor-trloop.html',
          editor: me,
          title: '插入表单项目',
          cssRules: 'width:600px;height:300px;'
        })
      ...
      queryCommandState: function(cmd) {
        var me = this
        UT = UE.UETable
        var sle = UT.getUETableBySelected(me)
        if (sle !== null) {
          var cr = sle.cellsRange
          if (cr.beginRowIndex === cr.endRowIndex && cr.endColIndex - cr.beginColIndex === sle.colsNum - 1) {
            return 0
          }
        }
        return -1
    ...
    regQmEditorMenu({
      label: '新增数据行',
      cmdName: 'qmEditorTrLoop_AddData',
      execCommand: function(cmd) {
        var me = this
        var rng = me.selection.getRange()
        var tr = domUtils.findParentByTagName(rng.startContainer, 'tr', true)
        var newTr = tr.cloneNode()
        newTr.innerHTML = tr.innerHTML
        newTr.setAttribute('qmtype', 'row')
        tr.insertAdjacentHTML('afterend', newTr.outerHTML)
      },
      queryCommandState: function(cmd) {
        if (qmEditorData.mode !== 'disp') {
          return -1
        }
        var me = this
        UT = UE.UETable
        ...
        if (sle !== null) {
          ...
          if (cr.beginRowIndex === cr.endRowIndex && cr.endColIndex - cr.beginColIndex === sle.colsNum - 1) {
            var rng = me.selection.getRange()
            var tr = domUtils.findParentByTagName(rng.startContainer, 'tr', true)
            return tr.hasAttribute('qmcode') ? 0 : -1
          }
        }
        return -1
      }
    ...
    regQmEditorMenu({
      label: '删除数据行',
      cmdName: 'qmEditorTrLoop_DelData',
      execCommand: function(cmd) {
        var me = this
        var rng = me.selection.getRange()
        var tr = domUtils.findParentByTagName(rng.startContainer, 'tr', true)
      ...
      queryCommandState: function(cmd) {
        ...
        if (sle !== null) {
          ...
          if (cr.beginRowIndex === cr.endRowIndex && cr.endColIndex - cr.beginColIndex === sle.colsNum - 1) {
            var rng = me.selection.getRange()
            var tr = domUtils.findParentByTagName(rng.startContainer, 'tr', true)
            return tr.getAttribute('qmtype') === 'row' ? 0 : -1
          }
        }
        return -1
      }
  ...
  // qmEditorContextmenu/js/qmEditorContextmenu.js
  UE.plugins['contextmenu'] = function() {
    ...
    var items = []
    if (regQmEditorMenu.addOnMenu) {
      items = items.concat(regQmEditorMenu.addOnMenu)
    }
    items = items.concat([
  ...
  // ueditor-1.4.3.3/_src/ui/uiutils.js
  ;(function() {
  ...
  // ueditor-1.4.3.3/_src/ui/uibase.js
  ;(function() {
  ...
  // ueditor-1.4.3.3/_src/ui/separator.js
  ;(function() {
    var utils = baidu.editor.utils,
  ...
  // ueditor-1.4.3.3/_src/ui/mask.js
  ///import core
  ///import uicore
  ;(function() {
    var utils = baidu.editor.utils,
  ...
  // ueditor-1.4.3.3/_src/ui/popup.js
  ///import core
  ///import uicore
  ;(function() {
    var utils = baidu.editor.utils,
  ...
  // ueditor-1.4.3.3/_src/ui/colorpicker.js
  ///import core
  ///import uicore
  ;(function() {
    var utils = baidu.editor.utils,
  ...
  // ueditor-1.4.3.3/_src/ui/tablepicker.js
  ///import core
  ///import uicore
  ;(function() {
    var utils = baidu.editor.utils,
  ...
  // ueditor-1.4.3.3/_src/ui/stateful.js
  ;(function() {
    var browser = baidu.editor.browser,
      domUtils = baidu.editor.dom.domUtils,
      uiUtils = baidu.editor.ui.uiUtils
  ...
  // ueditor-1.4.3.3/_src/ui/button.js
  ///import core
  ///import uicore
  ...
  // ueditor-1.4.3.3/_src/ui/splitbutton.js
  ///import core
  ///import uicore
  ///import ui/stateful.js
  ;(function() {
  ...
  // ueditor-1.4.3.3/_src/ui/colorbutton.js
  ///import core
  ///import uicore
  ...
  // ueditor-1.4.3.3/_src/ui/tablebutton.js
  ///import core
  ///import uicore
  ///import ui/popup.js
  ...
  // ueditor-1.4.3.3/_src/ui/cellalignpicker.js
  ///import core
  ///import uicore
  ;(function() {
    var utils = baidu.editor.utils,
  ...
  // ueditor-1.4.3.3/_src/ui/pastepicker.js
  ///import core
  ///import uicore
  ;(function() {
    var utils = baidu.editor.utils,
  ...
  // ueditor-1.4.3.3/_src/ui/toolbar.js
  ;(function() {
    var utils = baidu.editor.utils,
      uiUtils = baidu.editor.ui.uiUtils,
      UIBase = baidu.editor.ui.UIBase,
  ...
  // ueditor-1.4.3.3/_src/ui/menu.js
  ///import core
  ///import uicore
  ///import ui\popup.js
  ///import ui\stateful.js
  ...
  // ueditor-1.4.3.3/_src/ui/combox.js
  ///import core
  ///import uicore
  ///import ui/menu.js
  ///import ui/splitbutton.js
  ...
  // ueditor-1.4.3.3/_src/ui/dialog.js
  ///import core
  ///import uicore
  ///import ui/mask.js
  ///import ui/button.js
  ...
  // ueditor-1.4.3.3/_src/ui/menubutton.js
  ///import core
  ///import uicore
  ///import ui/menu.js
  ///import ui/splitbutton.js
  ...
  // ueditor-1.4.3.3/_src/ui/multiMenu.js
  ///import core
  ///import uicore
  ///commands 表情
  ;(function() {
  ...
  // ueditor-1.4.3.3/_src/ui/shortcutmenu.js
  ;(function() {
  ...
  // ueditor-1.4.3.3/_src/ui/message.js
  ///import core
  ///import uicore
  ;(function() {
    var utils = baidu.editor.utils,
  ...
  // ueditor-1.4.3.3/_src/adapter/editorui.js
  //ui跟编辑器的适配層
  ...
  // ueditor-1.4.3.3/_src/adapter/editor.js
  ///import core
  ///commands 全屏
  ...
  // ueditor-1.4.3.3/_src/adapter/message.js
