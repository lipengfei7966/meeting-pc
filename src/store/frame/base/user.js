import { platLogin, userLogin, groupLogin, guestLogin, login, logout, getInfo, getUser, getTitles, getMenus, getRoutes, getSubRoutes, switchTo, switchBack } from '@/api/frame/login'
