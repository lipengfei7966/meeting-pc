export default {
  data: {
    ...
    voucher: {
      ...
      amountDebit: '借方原币金额',
      amountCredit: '贷方原币金额',
      amountDebitLoad: '借方本币金额',
      amountCreditLoad: '贷方本币金额',
      otherSubjectCode: '对方科目',
      auditStatus: '审核状态',
      support: {
        supportCode: '字段编码',
        supportName: '字段名称',
        supportEnglishName: '英文名称'
      },
      vocTemplate: {
        form: {
          templateCode: '模板编码',
          ...
          docCharaters: '凭证类别字',
          createType: '制单方式',
          defaultMakeUser: '默认制单人',
          lastDocDelFlag: '红冲上次凭证',
          billCode: '凭证编号',
          billName: '单据数据源',
          conditionCol: '制单条件',
          groupCol: '合并条件',
        ...
        detailList: {
          ...
          toLoan: '借贷方向',
          currencyCol: '币种',
          toLoanFieldStard: '本币借贷金额',
          toLoanField: '原币借贷金额',
          supportCol: '辅助核算'
        },
        tab: {
          vocTemplateDetDtoList: '列表信息'
        },
        part: {
          part1: '基本信息'
        }
    ...
    mainContract: {
      ...
      contractCode: '合约',
      dataAttr: '数据来源',
      mainContractInfo: '主力合约信息',
      importTitle: '主力合约导入'
    },
    optionPrice: {
      optionContractCode: '合约代码',
      saveDate: '日期',
      dataSource: '数据来源',
      settlementPrice: '结算价',
      lastPrice: '收盘价',
      ...
      tab: {
        optionPriceInfo: '期权行情信息'
      },
      msg: {
        optionPriceIsEmply: '行情数据为空，无法保存'
      }
    },
    futuresSpotCompare: {
      form: {
