<template>
  <div v-el-drag-dialog class='bs-new-container dialog-wrapper'>
    ...
    <div class="mask"></div>
    <!-- 二级弹窗 -->
    <view-form-dialog ref='viewFormDialog' :param='dialog.param' v-if='dialogSelectVisible' :initChooseParam='initChooseParam' @closeHandler='dialogHandler'></view-form-dialog>
  </div>
</template>
