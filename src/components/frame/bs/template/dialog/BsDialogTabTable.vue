<template>
  <div ref='BsDialogTabEdit'>
    ...
    <main>
      <u-table use-virtual fixed-columns-roll stripe border class='table-content' ref="singleTable" highlight-current-row v-loading="loading" element-loading-spinner="el-icon-loading" :element-loading-text="$t('route.load')" :height='tableHeight' :row-height='24' @selection-change="handleSelectionChange" @current-change="handleSelectRow" @row-click='handleClick' @sort-change="handleSortChange" @row-dblclick="handleDblClick">
