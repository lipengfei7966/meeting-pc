<template>
  <div>
    ...
    <el-table :key='key' :default-expand-all="tab.table.expandAll" :rowKey="tab.table.rowKey" type="expand" stripe border class='table-content bs-tree-table' ref="singleTable" highlight-current-row v-loading="loading" element-loading-spinner="el-icon-loading" :element-loading-text="$t('route.load')" :data="tableData" :height='400' @current-change="handleSelectRow">
