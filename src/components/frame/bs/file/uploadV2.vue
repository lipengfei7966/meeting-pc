<template>
  <el-upload :show-file-list='showFileList' :accept='accept' :multiple='multiple' :disabled='disabled' :v-permission="permission" :headers="httpHeaders" :action="uploadUrl" :data="paramData" :before-upload="beforeUploadCallback" :on-progress="progressCallback" :on-success="successCallback" :on-error="errorCallback" :on-change="changeCallback" style='display:inline-block;margin-left:3px;'>
