...
export default {
  ...
  methods: {
    ...
    initTable() {
      this.loading = true
      request({
        url: '/api/func/orgFunc/listModulesWithOperatesByModuleCodeAndOrgFunc',
        method: 'POST',
        data: {
          funcModule: this.$t('route.' + this.$route.meta.title),
          funcOperation: this.$t('biz.btn.search'),
          data: {
            orgFuncCode: this.orgFuncCode,
    ...
    save() {
      this.$confirm(this.$t('biz.msg.confirmSave'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          ...
          request({
            url: '/api/func/orgFunc/saveOrgFuncDetail',
            method: 'POST',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
