...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          save: '/api/code/codeManage/saveMenu'
        },
        topButtons: [
          {
            iconName: 'close',
          ...
          part2: {
            ...
            content: [
              ...
              },
              {
                ...
                default: 'views/frame/base/generator/formwork/index'
              },
              {
                label: '组件名称',
                prop: 'componentName',
  ...
  methods: {
    parentCodeCallback(param) {
      if (param) {
        this.$refs.bsEdit.$refs.bsDialogEdit.editForm['parentName'] = param.cname
        this.$refs.bsEdit.$refs.bsDialogEdit.editForm['parentCode'] = param.code
      }
    },
    submit() {
