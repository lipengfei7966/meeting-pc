  ...
  <div>
    <div class='tabs-operate' style='margin-top:5px;'>
      ...
      <el-button v-db-click size="mini" @click='clear()'>
        <svg-icon icon-class="clear"></svg-icon>{{ $t('biz.btn.clear') }}
      </el-button>
    </div>
    <el-form :inline="true" class="header-form-inline" label-position="left" style='margin-top:3px;'>
      <el-row :gutter="20">
        ...
        <el-col :span="24">
          <el-form-item :label="$t('msg.templet.templetContent')" prop='msgTemplate'>
            <el-input v-model="tmplObj.msgTemplate"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item :label="$t('msg.templet.templetExtend')" prop='targetUrl'>
            <el-input v-model="tmplObj.targetUrl"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item :label="$t('msg.templet.templetContentForCommon')" prop='reservedStr1'>
            <el-input v-model="tmplObj.reservedStr1"></el-input>
          </el-form-item>
        </el-col>
