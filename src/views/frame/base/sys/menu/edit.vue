<template>
  <bs-edit ref='bsEdit' :edit='edit' @closeDialog='handleCloseDialog' @initCallback='handleInitCallback'></bs-edit>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    changeLeafFlag(param) {
      if (param && param === '1') {
        //自有菜单
        this.$refs.bsEdit.$refs.bsDialogEdit.edit.formData['part2'].hidden = false
      } else {
        this.$refs.bsEdit.$refs.bsDialogEdit.edit.formData['part2'].hidden = true
      }
    },
    // 初始化回调
