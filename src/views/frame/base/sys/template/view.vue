    ...
    view(businessCategory, businessDataId) {
      ...
      fleTemplateUseApi.getByDataId({
        ...
        if (response.data !== null) {
          ...
          subDoc.writeln('<link rel="stylesheet" type="text/css" href="../../../../../static/bseditor/bsEditorAddon/bsEditor/bsEditor.css" />')
          subDoc.writeln('<link rel="stylesheet" type="text/css" href="../../../../../static/bseditor/bsEditorAddon/bsEditorPreview/preview.css" />')
          subDoc.writeln('<scr' + 'ipt type="text/javascript" charset="utf-8" src="../../../../../static/bseditor/bsEditorAddon/bsEditorPreview/preview.js"></scr' + 'ipt>')
          subDoc.writeln('</head>')
          subDoc.writeln('<body>')
