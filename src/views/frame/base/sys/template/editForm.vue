...
export default {
  ...
  methods: {
    ...
    handleInitCallback(data) {
      ...
      if (win) {
        win.setContent(data.templateContent)
      }
    },
    onSave() {
      this.$loopDOM(this, 'bsDialogEdit').editForm.templateContent = this.$loopDOM(this, 'templateInfo')[0].template.editorWin.getContent()
      return true
    }
  }
}
