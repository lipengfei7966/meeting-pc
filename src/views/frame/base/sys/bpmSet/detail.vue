<template>
  <bs-edit :edit='edit' ref='bsEdit' @closeDialog='handleCloseDialog'></bs-edit>
</template>
    ...
    return {
      edit: {
        ...
        tabs: [
          ...
          {
            name: 'branch',
            label: 'sys.bpmSet.tab.branch',
            component: () => import('./components/branchTab.vue')
          },
          {
            name: 'tabDocFormPreview',
            label: 'sys.bpmSet.tab.tabDocFormPreview',
            component: () => import('./components/tabDocFormPreview.vue')
          },
          {
            name: 'tabEmployee',
