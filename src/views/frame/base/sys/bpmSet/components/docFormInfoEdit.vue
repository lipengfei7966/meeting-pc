<template>
  <bs-dialog ref='dialog' :dialog='dialog' @closeDialog='handleCloseDialog' @initCallback='handleInitCallback'></bs-dialog>
</template>
  ...
  data() {
    return {
      dialog: {
        ...
        styleType: 'medium',
        initType: 'api',
        titleName: this.$t('sys.bpmSet.tab.tabDocFormPreview'),
