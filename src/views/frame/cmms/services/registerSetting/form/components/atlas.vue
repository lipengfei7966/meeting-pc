    ...
    <div class='dialog-container' :style="{width: this.sidebar.opened ? '800px' : '1000px'}">
      ...
      <div class='dialog-content dialog-container__content' :style="{maxHeight: clientHeight - 80 + 'px', overflowY: 'auto','padding-bottom': '0px !important'}">
        <div class="atlas" v-loading="loading" :element-loading-text="loadingText">
          <el-form ref="atlasForm" :model="atlasForm" label-width="120px" label-position="right" class="formWrap" :rules="rules" :show-message='false'>
            ...
            <el-form-item :label="$t('website.atlas.atlasIntroduction')+'：'">
              <el-input type="textarea" :rows="3" v-model="atlasForm.description">
              </el-input>
            </el-form-item>
          </el-form>
        </div>
