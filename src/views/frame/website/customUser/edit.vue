<template>
  <bs-dialog ref='bsDialog' :initFun='initFun' :dialog='dialog' @closeDialog='handleCloseDialog'></bs-dialog>
</template>
...
export default {
  ...
  methods: {
    ...
    // 保存通用事件
    save() {
      this.$refs.bsDialog.$refs.refForm.validate(valid => {
        if (valid) {
          this.$confirm(this.$t('biz.msg.confirmSave'), this.$t('biz.msg.tip'), {
            ...
            .then(() => {
              if (this.opType === 'add') {
                ...
                this.$refs.bsDialog.formData['random'] = random
                this.$refs.bsDialog.formData['passwordO'] = aesEncrypt(this.$refs.bsDialog.formData['password'], random)
                this.$refs.bsDialog.formData['password'] = encriptPwd(this.$refs.bsDialog.formData['password'])
              }
              request({
                url: this.$refs.bsDialog.dialog.type === 'add' ? this.$refs.bsDialog.dialog.api.save : this.$refs.bsDialog.dialog.api.update,
                method: 'POST',
                data: {
