<template>
  <div class="bs-new-container app-container" :style="{'left': sidebar.opened == 0 ? '10px !important' : '0 !important','width': sidebar.opened == 1 ? '100% !important' : ' calc(100% - 10px) !important'}">
