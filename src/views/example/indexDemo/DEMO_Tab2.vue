<template>
  <bs-edit-tab ref='tab' :tab='tab' @closeHandler='dialogHandler'></bs-edit-tab>
</template>
...
export default {
  ...
  methods: {
    ...
    // 增行打开弹窗设置默认查询条件
    doAdd() {
      this.$refs.tab.$refs.viewFormTab.$refs.bsDialogTable.listQuery.data.productCategoryName = '123'
    },
    doDeleteRow(param) {
