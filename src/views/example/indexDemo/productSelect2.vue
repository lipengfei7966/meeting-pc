<template>
  <bs-dialog-tab-table ref='bsDialogTabEdit' v-on="$listeners" :dialog='dialog' @closeDialog='handleCloseDialog'></bs-dialog-tab-table>
</template>
...
export default {
  ...
  mounted() {
    this.$refs.bsDialogTabEdit.tableData = [
      {
