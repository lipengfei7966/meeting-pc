<template>
  <div class="addPrincipal">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item class="el-bread-item">编辑会议合规人规则</el-breadcrumb-item>
    </el-breadcrumb>

    <p style="font-size: 17px; padding: 15px 0">新建/编辑会议合规人规则 </p>

    <el-form ref="headeRuleForm" :model="formData" :rules="rules" label-width="250px" label-position="left" class="addPrincipalForm">
      <el-form-item label="合规人用户:" prop="username">
      ...
      <el-form-item label="会议指定供应商:" prop="service">
        <el-select v-model="formData.service" size="small" multiple filterable @change="changeCustomer" placeholder="请选择">
...
export default {
  data: function() {
    return {
      ...
      rules: {
        username: [{ required: true, message: '请选择合规人用户', trigger: 'change' }],
  ...
  methods: {
      ...
      this.$refs["headeRuleForm"].validate((valid) => {
        if(valid){
          ...
          let Parameter = {
            ...
            type: 4, //1、负责人，2、采购人，3、会议助理，4、合规人员
    ...
    cancel() {
      this.$router.push({name:'relatedPersonSetting',query:{activeName:'fourth'}})
    },
    changeCustomer(){
      this.GetMeetingType(this.formData.company_id)
    },
