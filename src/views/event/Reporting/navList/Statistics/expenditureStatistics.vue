<template>
  <div>
      ...
      <div class="filter clx">
        ...
        <div class="filter_item">
          <div class="filter_box filter_date">
            <select class="date_select" autocomplete="off" name="start_year" v-model="mettingStartYear">
              <option :value="item.datey" v-for="(item, index) in dateListed" :key="item.id">{{ item.datey }} 年</option>
            </select>
            <select name="start_month" class="date_select" autocomplete="off" v-model="mettingStartMonth">
              <option :value="item.datem" v-for="(item, index) in monthList" :key="item.id">{{ item.datem }} 月</option>
            </select>
          </div>
          <div class="filter_sl">～</div>
          <div class="filter_box filter_date">
            <select class="date_select" autocomplete="off" name="start_year" v-model="mettingEndYear">
              <option :value="item.datey" v-for="(item, index) in dateListed" :key="item.id">{{ item.datey }} 年</option>
            </select>
            <select name="start_month" class="date_select" autocomplete="off" v-model="mettingEndMonth">
              <option :value="item.datem" v-for="(item, index) in monthList" :key="item.id">{{ item.datem }} 月</option>
            </select>
          </div>
        </div>
    ...
    <div class="canvas_top">
      <BrokenLineOne :dateList="dateList" v-show="dateList" />
      <div class="none" v-show="!dateList">
  ...
  methods: {
    ...
    costStatistics() {
      this.requestApi({
        ...
        method: 'GET',
        data: {
          BeginYear: this.mettingStartYear,
          BeginMonth: this.mettingStartMonth,
          EndYear: this.mettingEndYear,
          EndMonth: this.mettingEndMonth,
