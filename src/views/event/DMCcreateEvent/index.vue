        ...
        <div class="base_meet">
          <el-form :model="baseMeet" :rules="rules" ref="baseMeet" label-width="300px">
            ...
            <el-form-item label="客户联系电话 Owner's Phone NO.">
              <el-input class="demand_500" disabled clearable v-model="baseMeet.phone"></el-input>
            </el-form-item>
            ...
            <el-form-item label="会议城市 City" prop="event_city">
              <el-select :disabled="baseMeet.online_meeting" class="demand_500" clearable filterable v-model="baseMeet.event_city">
            ...
            <el-form-item label="附件 Document Attachments">
              <div class="demand_500 text_left">
                <el-upload ref="upload" :before-upload="fileLimit" :action="UploadFilesUrl" :on-success="uploadFile" :on-preview="downloadFile" :on-remove="deleteFile" :file-list="fileList" :show-file-list="true" :multiple="true">
            ...
            <el-form-item label="指定供应商 supplier">
              <el-input v-input-filter:int class="demand_500" disabled v-model="baseMeet.service_provider_name"></el-input>
            </el-form-item>
            <!-- <div class="row_around" style="margin-right:50px">
              <el-button class="submit_btn" v-on:click="subEvent(0)" type="primary">{{ eventId?'保存':'创建会议'}}</el-button>
              <el-button v-if="!eventId" class="submit_btn" v-on:click="subEvent(1)" type="info">保存草稿</el-button>
            </div> -->
            <div class="row_around" style="margin-right:50px">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        departmentName: [{ required: true, message: '客户联系人必须有所属部门', trigger: 'change' }],
  ...
  methods: {
    ...
    ServiceProviderUser(){
      this.requestApi({
        url: '/MeetingMa/ServiceProviderUser',
        method: 'POST',
        data: {},
      }).then(res => {
        this.baseMeet.service_provider_id = res.service_provider_id;
        this.baseMeet.service_provider_name = res.name;
      })
    },
    getServiceType(){
      this.requestApi({
        ...
        if(!this.baseMeet.service_type){
          this.baseMeet.service_type = this.serviceList[0].id
           // 会议等非旅游服务  发票类型 默认专票
          ...
          if(valid){
            ...
            if(this.eventId){
              ...
              this.requestApi({
                ...
                // this.$router.push({path:'/DMCEventList'})
              })
            }
          }else{
    ...
    uploadFile(e) {
      ...
      // this.baseMeet.fileInfos.push({name:e.title, url: e.weburl});
    ...
    getContactInfo(id){
      this.requestApi({
        ...
        if(res) {
          ...
          // } else {
          //   this.baseMeet.company_contacts = '';
          //   this.$message.warning('该联系人未关联部门！');
          // }
        }
      })
    },
