...
const whiteList = ['/platform/login', '/old/login', '/group/login', '/user/login', '/custom/login', '/login', '/401', '/404'] // 不重定向白名单
const logninList = ['/login', '/platform/login', '/old/login', '/group/login', '/user/login', '/custom/login'] // 不重定向白名单
